    ...
    <div class="page-header-inner">
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 250px;">
                                <li>
                                    ...
                                    <span class="photo">
                                    <img src="/dashboard/layouts/layout/img/avatar2.jpg" alt=""/>
                                    </span>
                                    <span class="subject">
                                    <span class="from">
                                    Lisa Wong </span>
                                ...
                                <li>
                                    <a href="inbox.html?a=view">
                                    <span class="photo">
                                    <img src="/dashboard/layouts/layout/img/avatar3.jpg" alt=""/>
                                    </span>
                                    <span class="subject">
                                    <span class="from">
                                    Richard Doe </span>
                                ...
                                <li>
                                    <a href="inbox.html?a=view">
                                    <span class="photo">
                                    <img src="/dashboard/layouts/layout/img/avatar1.jpg" alt=""/>
                                    </span>
                                    <span class="subject">
                                    <span class="from">
                                    Bob Nilson </span>
                ...
                <order-header-bar></order-header-bar>
                <!-- END ORDER HEADER BAR-->
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="inbox.html">
                            <i class="/inbox"></i> My Inbox <span class="badge badge-danger">
                            3 </span>
                            </a>
                        </li>
                        <li>
