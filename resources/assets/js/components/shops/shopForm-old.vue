...
export default{
    ...
    methods:{
        ...
        reload: function(){
            ...
            _shopForm.shop = {id:'', name: '', description: '', logo: '', address: '', geo:'', customer_id: _shopForm.pcustomer_id};
            _shopForm.map = { markers: [], center : {lat: -34.6248187, lng: -58.3761432}, zoom: 12};
