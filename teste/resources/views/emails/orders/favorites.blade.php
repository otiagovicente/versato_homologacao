    ...
    <table cellspacing="0" cellpading="0" width="100%" height="100px" style="margin-top:50px;">
      <tr>
        ...
        <td valign="top" bgcolor="#33495F" width="40%" align="right">
          <!-- linha 1 -->
          <span style="font-family: Helvetica, 'Arial', sans-serif; font-size:24px; font-weight:normal; color: white; margin-top: 20px; margin-right:20px; float:left; width: 90%">
             <b>Lista de Favoritos</b>
          </span>
          <!-- /linha 1 -->
          <!-- linha 2 -->
          <span style="font-family: Helvetica, 'Arial', sans-serif; font-size:14px; font-weight:normal; color: #ccc; margin-top: 10px; float:left; margin-right:20px; width:90%">
            {{date('d/m/Y')}} - {{$representative->user->name}}
          </span>
          <!-- /linha 2 -->
        </td>
      </tr>
            ...
            <tr>
                <td valign="center" align="left" bgcolor="#ffffff" style="padding-left:2%;" width="32%" height="60px">
                    <span style="font-family: Helvetica, 'Arial', sans-serif; font-size:12px; font-weight:normal; color: #000; margin-top: 15px;  width: 100%; text-align:center">
                        {{ $product->line->description }} {{ $product->material? $product->material->description: '' }} {{ $product->color? $product->color->description:'' }}
                    </span>
                </td>
    ...
    <table cellspacing="4" cellpading="0" width="100%" height="60px" style="border:1px solid #e2e2e2; margin-top:5px;">
      <tr>
        <td valign="center" align="left" bgcolor="#f2f2f2" width="35%">
          <span style="margin-left:4%;font-family: Helvetica, 'Arial', sans-serif; font-size:12px; font-weight:normal; color: #999; margin-top: 15px;  width: 100%; text-align:center"><b></b></span>
        </td>
        <td valign="center" align="center" bgcolor="#f2f2f2" width="16%">
        ...
        <td valign="center" align="right" bgcolor="#f2f2f2" width="46%">
          <span style="margin-right:10px;font-family: Helvetica, 'Arial', sans-serif; font-size:16px; font-weight:normal; color: #000; margin-top: 15px;   width: 100%; text-align:center">
            <b></b>
          </span>
        </td>
      </tr>
